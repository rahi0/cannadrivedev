...
class SubmitDriverDetailsForm extends StatefulWidget {
  @override
  _SubmitDriverDetailsFormState createState() => _SubmitDriverDetailsFormState();
}

class _SubmitDriverDetailsFormState extends State<SubmitDriverDetailsForm> {
                    ...
                    blurRadius: 14.0,
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButton<String>(
                                ...
                                }).toList():_dayTwentyEight.map((String dropDownStringItem) {
                                  return DropdownMenuItem<String>(
                                      value: dropDownStringItem,
                                      child: Padding(
                                        padding: EdgeInsets.only(left: 20),
